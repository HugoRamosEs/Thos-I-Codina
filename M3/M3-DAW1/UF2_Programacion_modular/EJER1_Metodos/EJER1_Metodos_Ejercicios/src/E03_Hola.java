...
public class E03_Hola {
	...
	/**
	 * Escribe el caracter c las veces indicadas
	 * @param n veces que se tiene que repetir
	...
	/**
	 * Muestra un marco hecho con el caracter c, y dentro escribe la frase
	 * @param n frase
	 * @param c caracter para dibujar
	 */
	
	void enmarcar(String n, char c) {
		repetir(n.length()+4, c);
		System.out.println();
		System.out.print(c);
		repetir(n.length()+2, ' ');
