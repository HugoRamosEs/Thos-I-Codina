...
$experiencies = array ("D" => "Dolenta", "R" => "Regular", "B" => "Bona", "MB" => "Molt Bona");
$idiomesDelFormulari = array ("es" => "castellano" , "ca" => "català" , "fr" => "français" , "en" => "english" , "hu" => "hugaro");

$pagina = array ("1" => "index", "2" => "projectes", "3" => "exercicis", "4" => "llibreVisites", "5" => "contacta");

//define ("IDIOMA_PER_DEFECTE","ca");
...
$dbPassword = "ThosiCodina#2019";
$dbBaseDeDades = "myweb";

$rutaDelGuestBook = "model/llibreDeVisites.xml";