<section class="infos">
	<!-- multistep form -->
	<form id="msform" action="?User/register" method="post" autocomplete="off" enctype="multipart/form-data">
		<!-- progressbar -->
		<ul id="progressbar">
		...
		<fieldset>
			...
			<span class="error"> <?php echo (isset($user->errorsDetectats["error"]))?$user->errorsDetectats["error"]:"";?> </span>
				<?php
                echo $input_email;
                echo $input_pass;
                echo $input_cpass;
		...
		<fieldset>
            ...
            echo $input_imatge;
            ?>
			<span class="error" style="color: red;"> <?php echo (isset($user->errorsDetectats["baseDades"]))?$user->errorsDetectats["baseDades"]:"";?> </span>
			<?php
            echo $input_bPrev;
            echo $input_bSend;
            ?>
