...
--
-- Base de dades: `tickettune`
--
DROP DATABASE IF EXISTS tickettune;
CREATE DATABASE IF NOT EXISTS tickettune CHARACTER SET utf8 COLLATE utf8_general_ci;
USE tickettune;
...
CREATE TABLE `USER` (
    ...
    `dateOfBirth` VARCHAR(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
--
-- AUTO_INCREMENT para la tabla `USER`
--
ALTER TABLE `USER`
