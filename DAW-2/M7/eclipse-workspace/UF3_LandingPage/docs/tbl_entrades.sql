...
--
-- Indices de la tabla `tbl_usuaris` (Comentado por problemas con la practica de los usuarios).
--
/*
- MODIFICADO EN EL SCRIPT DE LA PRÁCTICA ANTERIOR
...
/*
- MODIFICADO EN EL SCRIPT DE LA PRÁCTICA ANTERIOR
ALTER TABLE `tbl_usuaris` (Comentado por problemas con la practica de los usuarios).
