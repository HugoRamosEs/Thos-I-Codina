...
public class About extends JDialog {
	...
	public void afegirComponents() {
		...
		lbl_aImg.setIcon(new ImageIcon(About.class.getResource("/votacions/vista/recursos/app-logo_128px.png")));
	...
	public Font carregarFont(String estil, int tamany) {
		try (InputStream is = About.class.getResourceAsStream("/votacions/vista/recursos/minecraftia.ttf")) {
